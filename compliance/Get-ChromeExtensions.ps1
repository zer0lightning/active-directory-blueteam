# Credits: https://gist.github.com/GarnetSunset/f35f73b44cc637b2b3ff24a75be36cd3
...
$auditfilepath = "$($auditfolderpath)\GoogleChrome-$($env:USERNAME)-$($env:COMPUTERNAME).txt"
